...
Release transfer sizes: world WASM 51 KiB raw / 21,557 bytes gzip; DSP WASM 73 KiB raw / 28,005 bytes gzip. Audio remains lazy-loaded. Chrome and Firefox pass HTTP, Worker, packed-buffer, deliberate fallback, user-gesture, AudioWorklet, and nonzero DSP smoke checks. Safari automation remains pending because Safari's persistent “Allow remote automation” security setting is disabled.
